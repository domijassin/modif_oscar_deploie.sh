...
sed -i "/%programfiles%/a \if exist \"%programfiles%\\\Wpkg-GP\" echo oui  > %windir%\\\oscar_deploie\\\oui_wpkg" /home/a/admin/perso/oscar_deploie/oscar_deploie_numero_poste.bat
...
sed -i "39d" /home/a/admin/perso/oscar_deploie/oscar_deploie_numero_poste.bat
